...
public class Test_PCD8544 {
	...
	private final int LCD_X = 84;
	private final int LCD_Y = 48;
	...
	public static void main(String args[]) {
		...
		Test_PCD8544 app = new Test_PCD8544();
		app.run();
	}
	...
	private void LcdCharacter(char character) throws PigpioException {
	...
	private void LcdClear() throws PigpioException {
		for (int index = 0; index < LCD_X * LCD_Y / 8; index++) {
			LcdWrite(LCD_DATA, 0x00);
		}
	}

	private void LcdInitialise() throws PigpioException {

			pigpio.gpioSetMode(PIN_SCE, Pigpio.PI_OUTPUT);
			pigpio.gpioSetMode(PIN_RESET, Pigpio.PI_OUTPUT);
			pigpio.gpioSetMode(PIN_DC, Pigpio.PI_OUTPUT);
			pigpio.gpioSetMode(PIN_SDIN, Pigpio.PI_OUTPUT);
	...
	private void LcdString(String characters) throws PigpioException {
